        ...
        <ui-card [title]="'backoffice.currentEntry' | translate" variant="success" [hoverable]="false">
          ...
          <div class="flex items-center gap-4">
            ...
            <div class="flex gap-3 flex-wrap">
              <!-- Place Back Button -->
              <button
                class="px-6 py-2.5 bg-gradient-to-r from-amber-600 to-orange-600 text-white rounded-lg font-bold hover:from-amber-700 hover:to-orange-700 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-md hover:shadow-lg"
                (click)="placeBackClick.emit()"
                [disabled]="isLoading">
                @if (isLoading) {
                  ...
                  <span class="flex items-center gap-2">
                    ...
                    <span>{{ 'backoffice.placeBackToQueue' | translate }}</span>
                  </span>
                }
              </button>
...
export class CurrentEntryCardComponent {
  ...
  @Output() placeBackClick = new EventEmitter<void>();
