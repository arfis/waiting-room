...
// MANUAL OVERRIDE: Using FlexibleTime for date fields to support multiple formats
package dto
...
func (queueEntry QueueEntry) GetAppointmentTimeAsTime() time.Time {
	var v time.Time
	if queueEntry.AppointmentTime != nil {
		return queueEntry.AppointmentTime.Time
	}
	return v
}

func (queueEntry QueueEntry) GetCreatedAt() time.Time {
	return queueEntry.CreatedAt
}
