...
func Generated(r chi.Router, diContainer *dig.Container) {
	err := diContainer.Invoke(func(
		...
		r.With(authorizationMiddleware.Middleware()).Group(func(protected chi.Router) {
			...
			protected.Get("/admin/tenants/{tenantId}/sections", adminHandler.GetAllSections)
			protected.Post("/admin/tenants/{tenantId}/sections", adminHandler.CreateSection)
			protected.Delete("/admin/tenants/{tenantId}/sections/{sectionId}", adminHandler.DeleteSection)
			protected.Get("/admin/tenants/{tenantId}/sections/{sectionId}", adminHandler.GetSection)
			protected.Put("/admin/tenants/{tenantId}/sections/{sectionId}", adminHandler.UpdateSection)
