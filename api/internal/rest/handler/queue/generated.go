...
func (h *Handler) GetQueueEntryByToken(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		slog.Error("GetQueueEntryByToken - error writing response", "error", err)
	}
}
...
func (h *Handler) FinishCurrent(w http.ResponseWriter, r *http.Request) {
	...
	err := handler.WriteJson(r.Context(), w, 200, resp)
	if err != nil {
		slog.Error("FinishCurrent - error writing response", "error", err)
	}
}
...
func (h *Handler) GetQueueEntries(w http.ResponseWriter, r *http.Request) {
	...
	err := handler.WriteJson(r.Context(), w, 200, resp)
	if err != nil {
		slog.Error("GetQueueEntries - error writing response", "error", err)
	}
}
...
func (h *Handler) GetServicePoints(w http.ResponseWriter, r *http.Request) {
	...
	err := handler.WriteJson(r.Context(), w, 200, resp)
	if err != nil {
		slog.Error("GetServicePoints - error writing response", "error", err)
	}
}

func (h *Handler) CallSpecificEntry(w http.ResponseWriter, r *http.Request) {
	var applicationErr error
	entryId := handler.PathParamToString(r, "entryId")
	roomId := handler.PathParamToString(r, "roomId")
	servicePointId := handler.PathParamToString(r, "servicePointId")
	var resp *dto.QueueEntry
	resp, applicationErr = h.svc.CallSpecificEntry(
		r.Context(),
		entryId,
		roomId,
		servicePointId,
	...
	err := handler.WriteJson(r.Context(), w, 200, resp)
	if err != nil {
		slog.Error("CallSpecificEntry - error writing response", "error", err)
	}
}
...
func (h *Handler) FinishCurrentForServicePoint(w http.ResponseWriter, r *http.Request) {
	...
	err := handler.WriteJson(r.Context(), w, 200, resp)
	if err != nil {
		slog.Error("FinishCurrentForServicePoint - error writing response", "error", err)
	}
}
...
func (h *Handler) MarkInRoomForServicePoint(w http.ResponseWriter, r *http.Request) {
	...
	err := handler.WriteJson(r.Context(), w, 200, resp)
	if err != nil {
		slog.Error("MarkInRoomForServicePoint - error writing response", "error", err)
	}
}
...
func (h *Handler) CallNext(w http.ResponseWriter, r *http.Request) {
	...
	err := handler.WriteJson(r.Context(), w, 200, resp)
	if err != nil {
		slog.Error("CallNext - error writing response", "error", err)
	}
}
