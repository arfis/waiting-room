...
func (h *Handler) GetAppointmentServices(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		slog.Error("GetAppointmentServices - error writing response", "error", err)
	}
}
...
func (h *Handler) GetDefaultServicePoint(w http.ResponseWriter, r *http.Request) {
	...
	err := handler.WriteJson(r.Context(), w, 200, resp)
	if err != nil {
		slog.Error("GetDefaultServicePoint - error writing response", "error", err)
	}
}
...
func (h *Handler) GetGenericServices(w http.ResponseWriter, r *http.Request) {
	...
	err := handler.WriteJson(r.Context(), w, 200, resp)
	if err != nil {
		slog.Error("GetGenericServices - error writing response", "error", err)
	}
}
...
func (h *Handler) GetUserServices(w http.ResponseWriter, r *http.Request) {
	...
	err := handler.WriteJson(r.Context(), w, 200, resp)
	if err != nil {
		slog.Error("GetUserServices - error writing response", "error", err)
	}
}
...
func (h *Handler) SwipeCard(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		slog.Error("SwipeCard - error writing response", "error", err)
	}
}
