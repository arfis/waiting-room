...
func WriteJson(c context.Context, w http.ResponseWriter, status int, dto any) error {
	...
	if err != nil {
		return errors.System(err, nil)
	}
	w.Header().Set("Content-Type", "application/json; charset=utf-8")
	w.WriteHeader(status)
	_, err = w.Write(b)
	if err != nil {
		return errors.NewResponseWriteError(err, true)
	}
	return err
}
...
func GetPageParams(r *http.Request) (page int32, size int32) {
	...
	return service.SafeInt64ToInt32(int64(p)), service.SafeInt64ToInt32(int64(s))
}
...
func CreatePage(content any, page int32, size int32, totalElements int64, sort []string) *dto.Page {
	...
	return &dto.Page{
		...
		NumberOfElements: service.SafeInt64ToInt32(int64(numberOfElements)),
		Size:             size,
